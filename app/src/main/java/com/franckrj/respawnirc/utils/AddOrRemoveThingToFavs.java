...
public class AddOrRemoveThingToFavs extends AbsWebRequestAsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        pageContent = WebManager.sendRequest("https://www.jeuxvideo.com/forums/user/favorite/?ajax_hash=" + ajaxInfos, "POST", "id_forum=" + forumId + "&id_topic=" + topicId + "&action=" + actionToDo + "&type=" + typeOfAction, currentWebInfos);
