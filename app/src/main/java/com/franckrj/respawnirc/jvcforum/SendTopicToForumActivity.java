...
public class SendTopicToForumActivity extends AbsHomeIsBackActivity implements InsertStuffDialogFragment.StuffInserted {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.enable_postasmodo_sendtopic) {
        ...
        if (itemId == R.id.action_clear_whole_topic_and_survey_sendtopic) {
        ...
        if (itemId == R.id.action_past_last_topic_sended_sendtopic) {
