...
public class InsertStuffDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        listOfCategoryButtons[0] = (ImageView) mainView.findViewById(R.id.smiley_button_insertstuff);
        listOfCategoryButtons[1] = (ImageView) mainView.findViewById(R.id.textformat_button_insertstuff);
        listOfCategoryButtons[2] = (ImageView) mainView.findViewById(R.id.sticker_1_button_insertstuff);
        listOfCategoryButtons[3] = (ImageView) mainView.findViewById(R.id.sticker_2_button_insertstuff);
        listOfCategoryButtons[4] = (ImageView) mainView.findViewById(R.id.sticker_3_button_insertstuff);
        listOfCategoryButtons[5] = (ImageView) mainView.findViewById(R.id.sticker_4_button_insertstuff);
        listOfCategoryButtons[6] = (ImageView) mainView.findViewById(R.id.sticker_5_button_insertstuff);
        listOfCategoryButtons[7] = (ImageView) mainView.findViewById(R.id.sticker_6_button_insertstuff);
        listOfCategoryButtons[8] = (ImageView) mainView.findViewById(R.id.sticker_7_button_insertstuff);
        listOfCategoryButtons[9] = (ImageView) mainView.findViewById(R.id.sticker_8_button_insertstuff);
        listOfCategoryButtons[10] = (ImageView) mainView.findViewById(R.id.sticker_9_button_insertstuff);
        listOfCategoryButtons[11] = (ImageView) mainView.findViewById(R.id.sticker_10_button_insertstuff);
        listOfCategoryButtons[12] = (ImageView) mainView.findViewById(R.id.sticker_11_button_insertstuff);
        listOfCategoryButtons[13] = (ImageView) mainView.findViewById(R.id.sticker_12_button_insertstuff);
        listOfCategoryButtons[14] = (ImageView) mainView.findViewById(R.id.sticker_13_button_insertstuff);
        listOfCategoryButtons[15] = (ImageView) mainView.findViewById(R.id.sticker_14_button_insertstuff);
        listOfCategoryButtons[16] = (ImageView) mainView.findViewById(R.id.sticker_15_button_insertstuff);
        listOfCategoryButtons[17] = (ImageView) mainView.findViewById(R.id.sticker_16_button_insertstuff);
        listOfCategoryButtons[18] = (ImageView) mainView.findViewById(R.id.sticker_17_button_insertstuff);
        listOfCategoryButtons[19] = (ImageView) mainView.findViewById(R.id.sticker_18_button_insertstuff);
        listOfCategoryButtons[20] = (ImageView) mainView.findViewById(R.id.sticker_19_button_insertstuff);
